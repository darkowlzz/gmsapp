...
public class TinyDB {
    ...
    public ArrayList<MediEvent> getListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MediEvent> objects =  new ArrayList<>();

        for(String jObjString : objStrings){
            MediEvent value  = (MediEvent) gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<MediEvent> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MediEvent obj : objArray){
